          ...
          {socials.map((social, index) => (
            <ScrollRevealSection key={social.name} delay={0.15 + index * 0.05}>
              ...
              >
                ...
                <div 
                  className="absolute w-12 h-12 [&>svg]:w-full [&>svg]:h-full transition-all duration-300 group-hover:w-6 group-hover:h-6 group-hover:relative group-hover:shrink-0"
                  style={{ 
