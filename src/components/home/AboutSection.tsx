    ...
    <section className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <ScrollRevealSection delay={0.6}>
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light">
            Creating content lets me be myself while bringing people together. There's something special about building
            a space where everyone feels welcome and can just be themselves.
          </p>
        </ScrollRevealSection>

        <ScrollRevealSection delay={0.7}>
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light">
            I believe in keeping things real and accessible. No gatekeeping, no pretense. Just honest conversations and
        ...
        <ScrollRevealSection delay={0.8}>
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light">
            The goal is to build a community that feels like home. A place where people can hang out, laugh, and connect
            with others who share the same energy.
          </p>
        </ScrollRevealSection>
      </div>
    </section>
