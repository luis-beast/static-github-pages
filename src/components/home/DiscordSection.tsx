      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <ScrollRevealSection delay={0.4}>
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative inline-flex items-center bg-[#5865F2] text-white rounded-2xl font-semibold text-lg overflow-hidden h-24 pl-6 pr-6 transition-all duration-500 ease-out"
          >
            {/* Content container */}
