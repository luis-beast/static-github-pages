          ...
          {socials.map((social, index) => (
            <ScrollRevealSection key={social.name} delay={0.15 + index * 0.05}>
              ...
              >
                ...
                {/* Single icon - moves left and shrinks on hover */}
                <div 
                  className="flex items-center gap-3 transition-all duration-300 ease-out group-hover:-translate-x-8"
                >
                  <div 
                    className="w-12 h-12 [&>svg]:w-full [&>svg]:h-full transition-all duration-300 group-hover:w-6 group-hover:h-6"
                    style={{ 
