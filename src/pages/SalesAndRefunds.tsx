...
const SalesAndRefunds = memo(function SalesAndRefunds() {
  return (
    <LegalPageLayout title="Sales & Refunds" lastUpdated="January 1, 2026">
      ...
      {/* What We Sell */}
      <LegalSection title="What We Sell" delay={0.05}>
        <LegalText>
      ...
      <LegalSection title="Digital Purchases and Refunds" delay={0.1}>
        <LegalText>
      ...
      {/* App Store Purchases */}
      <LegalSection title="App Store Purchases" delay={0.15}>
        <LegalText>
      ...
      {/* Subscriptions */}
      <LegalSection title="Subscriptions" delay={0.2}>
        <LegalText>
      ...
      <LegalSection title="Price Changes and Promotions" delay={0.25}>
        <LegalText>
      ...
      <LegalSection title="Chargebacks and Abuse" delay={0.3}>
        <LegalText>
        ...
        <LegalText emphasis className="mt-4">
          If something went wrong, please reach out first. We're humans over here.
        </LegalText>
      </LegalSection>

      {/* How to Request a Refund */}
      <LegalSection title="How to Request a Refund" delay={0.35}>
        <LegalText>
      ...
      {/* Processing Time */}
      <LegalSection title="Processing Time" delay={0.4}>
        <LegalText>
      ...
      {/* Contact */}
      <LegalSection title="Contact" delay={0.45}>
        <LegalText>
