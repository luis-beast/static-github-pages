      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <ScrollRevealSection delay={0.4}>
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            initial={false}
            className="group relative inline-flex items-center justify-center bg-[#5865F2] text-white rounded-2xl font-semibold text-lg overflow-hidden h-24 w-24 hover:w-60 transition-[width] duration-500 ease-out"
          >
            {/* Content container */}
            <div className="relative flex items-center px-6">
              {/* Icon - centered initially, moves left on hover */}
              <svg 
                className="w-12 h-12 shrink-0 transition-all duration-500 ease-out group-hover:-translate-x-1" 
                viewBox="0 0 24 24" 
                fill="currentColor"
              >
              ...
              <ExternalLink 
                className="w-4 h-4 shrink-0 transition-all duration-300 delay-200 ease-out opacity-0 ml-0 group-hover:opacity-100 group-hover:ml-2" 
              />
            </div>
          </motion.a>
        </ScrollRevealSection>
