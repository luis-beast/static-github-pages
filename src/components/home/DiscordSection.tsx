      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        <ScrollRevealSection delay={0.4}>
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            initial={false}
            className="group relative inline-flex items-center justify-center bg-[#5865F2] text-white rounded-2xl font-semibold text-lg overflow-hidden h-24 w-24 hover:w-56 transition-all duration-300"
          >
